...
import { FATPAPER_DOMAIN, USER_SERVER_PORT, USER_SERVER_PATH, USE_PORT } from "../global.config";
...
export const __FATPAPERUSERSERVERHOST__ = USE_PORT
	? `${FATPAPER_DOMAIN}:${USER_SERVER_PORT}`
	: `${FATPAPER_DOMAIN}/${USER_SERVER_PATH}`;
